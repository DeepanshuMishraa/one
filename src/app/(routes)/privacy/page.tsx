...
const sections = [
  {
    ...
    content: (
      <div className="space-y-4">
        <p>
          At One, we believe that privacy is a fundamental right. Our
          open-source calendar solution is built with privacy at its core, and
          we&apos;re committed to being transparent about how we handle your
          data.
        </p>
        <p className="font-semibold">
          Important: One is a client-only calendar application. We DO NOT store
          your calendar on our servers. All calendar data is processed directly
          between your browser and Google Calendar.
        </p>
        <p>Our verified privacy commitments:</p>
        <ul className="ml-4 list-disc space-y-2">
          <li>
            One Calendar Storage: We never store your calendar - it remains in
            your Google Calendar
          </li>
          <li>
            Client-Side Processing: All calendar processing happens in your
            browser
          </li>
          <li>Open Source: Our entire codebase is public and can be audited</li>
          <li>
            Minimal Data: We only request essential Google Calendar API
            permissions
          </li>
          <li>
            User Control: You can revoke our access to your Google Calendar at
            any time
          </li>
        </ul>
      </div>
  ...
  },
  {
    ...
    content: (
      <>
        <p className="mb-4">When you use One with your Google Account:</p>
        <ul className="ml-4 list-disc space-y-2">
          <li>
    ...
    content: (
      <div className="space-y-6">
        <div>
          ...
          <ul className="ml-4 list-disc space-y-2">
            <li>
              Calendar data is processed in accordance with Google API Services
              User Data Policy
            </li>
            <li>
              We only process and display calendar data - we don&apos;t store
        ...
        <div>
          ...
          <ul className="ml-4 list-disc space-y-2">
            <li>
              When you self-host One, your calendar data remains entirely under
              your control
            </li>
            <li>
          ...
          <ul className="ml-4 list-disc space-y-2">
            <li>
              ...
              <ul className="mt-2 ml-4 list-disc space-y-1">
                ...
                <li>Calendar metadata (title, dates, participants)</li>
