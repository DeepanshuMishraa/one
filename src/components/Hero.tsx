...
export default function Hero() {
  return (
    <div className="motion-blur-in-md motion-opacity-in-0 flex flex-col items-center justify-center mt-8 sm:mt-12 md:mt-20 px-4 space-y-6 sm:space-y-8 md:space-y-12">
      ...
      <div className="text-center space-y-3 sm:space-y-4 md:space-y-6 max-w-[90%] sm:max-w-xl md:max-w-2xl">
